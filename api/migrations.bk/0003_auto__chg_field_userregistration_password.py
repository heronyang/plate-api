...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserRegistration.password'
        db.alter_column(u'api_userregistration', 'password', self.gf('django.db.models.fields.CharField')(max_length=128))

    def backwards(self, orm):

        # Changing field 'UserRegistration.password'
        db.alter_column(u'api_userregistration', 'password', self.gf('django.db.models.fields.CharField')(max_length=50))
