...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VendorLastRequestTime'
        db.create_table(u'api_vendorlastrequesttime', (
        ...
        db.send_create_signal(u'api', ['VendorLastRequestTime'])

        # Adding model 'LastRegistrationTime'
        db.create_table(u'api_lastregistrationtime', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('last_time', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'api', ['LastRegistrationTime'])


    def backwards(self, orm):
        # Deleting model 'VendorLastRequestTime'
        db.delete_table(u'api_vendorlastrequesttime')

        # Deleting model 'LastRegistrationTime'
        db.delete_table(u'api_lastregistrationtime')
