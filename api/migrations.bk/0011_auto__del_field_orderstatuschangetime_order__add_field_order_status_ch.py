...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'OrderStatusChangeTime.order'
        db.delete_column(u'api_orderstatuschangetime', 'order_id')

        # Adding field 'Order.status_change_time'
        db.add_column(u'api_order', 'status_change_time',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.OrderStatusChangeTime'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'OrderStatusChangeTime.order'
        db.add_column(u'api_orderstatuschangetime', 'order',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=datetime.datetime(2014, 3, 10, 0, 0), to=orm['api.Order']),
                      keep_default=False)

        # Deleting field 'Order.status_change_time'
        db.delete_column(u'api_order', 'status_change_time_id')
    ...
    models = {
        ...
        u'api.order': {
            ...
            'restaurant': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['api.Restaurant']"}),
            'status': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'status_change_time': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['api.OrderStatusChangeTime']", 'null': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
        ...
        u'api.orderstatuschangetime': {
            'Meta': {'object_name': 'OrderStatusChangeTime'},
            'ctime': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'finish_time': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pickup_time': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'})
        },
        u'api.profile': {
