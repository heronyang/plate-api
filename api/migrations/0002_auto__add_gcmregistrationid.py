...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GCMRegistrationId'
        db.create_table(u'api_gcmregistrationid', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('gcm_registration_id', self.gf('django.db.models.fields.CharField')(max_length=600)),
        ))
        db.send_create_signal(u'api', ['GCMRegistrationId'])


    def backwards(self, orm):
        # Deleting model 'GCMRegistrationId'
        db.delete_table(u'api_gcmregistrationid')
