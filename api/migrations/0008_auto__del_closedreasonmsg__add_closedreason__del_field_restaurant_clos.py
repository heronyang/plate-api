...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ClosedReason'
        db.create_table(u'api_closedreason', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('msg', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal(u'api', ['ClosedReason'])
        ...
        # Adding field 'Restaurant.closed_every_other_weekend_initial_closed_weekend_sat'
        db.add_column(u'api_restaurant', 'closed_every_other_weekend_initial_closed_weekend_sat',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 1, 4, 0, 0), null=True),
                      keep_default=False)


        # Changing field 'Restaurant.closed_reason'
        db.alter_column(u'api_restaurant', 'closed_reason_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.ClosedReason'], null=True))

        # Changing field 'RestaurantOpenHours.start'
        db.alter_column(u'api_restaurantopenhours', 'start', self.gf('django.db.models.fields.TimeField')())

        # Changing field 'RestaurantOpenHours.end'
        db.alter_column(u'api_restaurantopenhours', 'end', self.gf('django.db.models.fields.TimeField')())
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ClosedReason'
        db.delete_table(u'api_closedreason')
        ...
        # Deleting field 'Restaurant.closed_every_other_weekend_initial_closed_weekend_sat'
        db.delete_column(u'api_restaurant', 'closed_every_other_weekend_initial_closed_weekend_sat')


        # Changing field 'Restaurant.closed_reason'
        db.alter_column(u'api_restaurant', 'closed_reason_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.ClosedReasonMsg'], null=True))

        # Changing field 'RestaurantOpenHours.start'
        db.alter_column(u'api_restaurantopenhours', 'start', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'RestaurantOpenHours.end'
        db.alter_column(u'api_restaurantopenhours', 'end', self.gf('django.db.models.fields.DateTimeField')())
